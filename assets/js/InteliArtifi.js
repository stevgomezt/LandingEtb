...
var modalPAC = document.getElementById('myModalInteliArtifi');
var videoInteliArtifi = document.getElementById('videoInteliArtifi');

document.getElementById("openModalBtnInteliArtifi").onclick = function () {
  $('#myModalInteliArtifi').modal('show');
  videoInteliArtifi.play(); // Iniciar la reproducción del video al abrir el modal
}

$('#myModalInteliArtifi').on('hidden.bs.modal', function () {
  videoInteliArtifi.pause();
  videoInteliArtifi.currentTime = 0;
});